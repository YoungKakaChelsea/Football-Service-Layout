    ...
    <body><script type="text/javascript">
            ...
            <div class="container">
                ...
                <div class="flexslider">
                    <ul class="slides">
                        ...
                        <li>
                            <div class="slide2">
                                <iframe width="80%" height="450" src="https://www.youtube.com/embed/PK9FZTVhArg" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </li>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-3 features">
                                            <a href="#">
                                                <img src="images/test-matche.jpg" alt="icon" class="img-responsive">
        ...
        <div class="container">
            ...
            <div class="row PageHead">
                <div class="col-md-12">
                    <a href="#"><h1>More Matches</h1></a>
                    <h3><a href="#">Premier Laliga</a> <a href="#">Bundesliga</a> <a href="#">Ligone Seria</a> <a href="#">Championship</a></h3>
                </div>
            </div>
